...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login_component__ = __webpack_require__(612);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__login_form_login_form_component__ = __webpack_require__(613);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_login_service__ = __webpack_require__(607);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_login_service__ = __webpack_require__(607);
...
var LoginPageComponent = /** @class */ (function () {
    ...
    LoginPageComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'fwf-page-login',template:/*ion-inline-start:"C:\FWF\football-with-friends-client\src\app\pages\login\login.component.html"*/'<ion-content class="login">\n\n    <!-- App/module name -->\n\n    <h1 class="app-name">\n\n        {{ "APPLICATION_DETAIL.NAME" | translate }}\n\n    </h1>\n\n    <!-- Login form -->\n\n    <fwf-login-form (submitted)="onSubmit($event)"></fwf-login-form>\n\n</ion-content>\n\n\n\n<ion-footer padding-horizontal>\n\n    <!-- <img class="logo" src="assets/img/"> -->\n\n    <h3 class="copyright">\n\n        {{ "APPLICATION_DETAIL.COPYRIGHT" | translate }}\n\n    </h3>\n\n</ion-footer>\n\n'/*ion-inline-end:"C:\FWF\football-with-friends-client\src\app\pages\login\login.component.html"*/,
        }),
...
var LoginFormComponent = /** @class */ (function () {
    ...
    LoginFormComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'fwf-login-form',template:/*ion-inline-start:"C:\FWF\football-with-friends-client\src\app\pages\login\login-form\login-form.component.html"*/'<form id="loginForm" [formGroup]="loginForm" (ngSubmit)="submit()" novalidate>\n\n\n\n    <!-- username -->\n\n    <ion-item>\n\n        <ion-input\n\n            id="username"\n\n            name="username"\n\n            formControlName="username"\n\n            placeholder="{{ \'LOGIN.USERNAME\' | translate }}"\n\n            required>\n\n        </ion-input>\n\n    </ion-item>\n\n    <!-- <fwf-control-messages\n\n        [submitted]="wasSubmitted"\n\n        [control]="loginForm.controls[\'username\']"\n\n        [waitTouch]="false">\n\n    </fwf-control-messages> -->\n\n\n\n    <!-- password -->\n\n    <ion-item>\n\n        <ion-input\n\n            id="password"\n\n            name="password"\n\n            type="password"\n\n            formControlName="password"\n\n            placeholder="{{ \'LOGIN.PASSWORD\' | translate }}"\n\n            required>\n\n        </ion-input>\n\n    </ion-item>\n\n    <!-- <fwf-control-messages\n\n        [submitted]="wasSubmitted"\n\n        [control]="loginForm.controls[\'password\']"\n\n        [waitTouch]="false">\n\n    </fwf-control-messages> -->\n\n\n\n    <!-- Submit button -->\n\n    <button ion-button\n\n            block\n\n            type="submit"\n\n            [disabled]="!canLogin">\n\n        {{ \'LOGIN.LOGIN\' | translate }}\n\n    </button>\n\n\n\n</form>\n\n'/*ion-inline-end:"C:\FWF\football-with-friends-client\src\app\pages\login\login-form\login-form.component.html"*/
        }),
