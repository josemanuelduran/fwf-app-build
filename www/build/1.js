...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_moment__ = __webpack_require__(606);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__payment_management_component__ = __webpack_require__(625);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_components_module__ = __webpack_require__(409);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_payment_management_players_payment_management_players_component__ = __webpack_require__(611);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_payment_management_pending_payment_management_pending_component__ = __webpack_require__(610);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components__ = __webpack_require__(608);
...
var PaymentManagementPlayersComponent = /** @class */ (function () {
    ...
    PaymentManagementPlayersComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'fwf-payment-management-players',template:/*ion-inline-start:"C:\FWF\fwf-client\src\app\pages\payment-management\components\payment-management-players\payment-management-players.component.html"*/'<ion-list list-grouped>\n\n    <ion-list-header>\n\n        {{\'PAYMENT_MANAGEMENT_PAGE.FIXED_HEADER\' | translate}}\n\n    </ion-list-header>\n\n    <ion-item\n\n            detail-push\n\n            *ngFor="let player of fixedPlayers"\n\n            (click)="playerSelected(player)"\n\n            text-wrap>\n\n        <h3 class="payment-nmme">\n\n            {{player.alias}}\n\n        </h3>\n\n    </ion-item>\n\n</ion-list>\n\n<ion-list list-grouped>\n\n    <ion-list-header>\n\n        {{\'PAYMENT_MANAGEMENT_PAGE.NO_FIXED_HEADER\' | translate}}\n\n    </ion-list-header>\n\n    <ion-item\n\n            detail-push\n\n            *ngFor="let player of noFixedPlayers"\n\n            (click)="playerSelected(player)"\n\n            text-wrap>\n\n        <h3 class="payment-name">\n\n            {{player.alias}}\n\n        </h3>\n\n    </ion-item>\n\n</ion-list>\n\n'/*ion-inline-end:"C:\FWF\fwf-client\src\app\pages\payment-management\components\payment-management-players\payment-management-players.component.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_payment_management_pending_payment_management_pending_component__ = __webpack_require__(610);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_payment_management_players_payment_management_players_component__ = __webpack_require__(611);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
