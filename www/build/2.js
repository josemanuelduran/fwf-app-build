...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__match_component__ = __webpack_require__(618);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components__ = __webpack_require__(608);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_scoreboard_scoreboard_component__ = __webpack_require__(415);
...
var MatchPageComponent = /** @class */ (function () {
    ...
    MatchPageComponent.prototype.editTeams = function () {
        ...
        if (this.match.callUp.length < this.match.numPlayers) {
            ...
            var dialog = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_5__components__["d" /* TeamsMakerComponent */], { match: this.match, player: this.player }, { enableBackdropDismiss: false });
    ...
    MatchPageComponent.prototype.setScoreBoard = function () {
        ...
        actionsPopover.onDidDismiss(function (data) {
            if (data && data.actionOk) {
                ...
                _this.match.openCallUp = false;
                _this.match.played = true;
    ...
    MatchPageComponent.prototype.setMatchPlayed = function () {
        this.matchPlayed =
            this.match.team1 && !Object(__WEBPACK_IMPORTED_MODULE_8_ionic_angular_util_util__["p" /* isUndefined */])(this.match.team1.goals) && this.match.team1.goals !== null
                && this.match.team2 && !Object(__WEBPACK_IMPORTED_MODULE_8_ionic_angular_util_util__["p" /* isUndefined */])(this.match.team2.goals) && this.match.team2.goals !== null;
    };
    ...
    MatchPageComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers__["k" /* PlayersService */],
